...
function Sehome(){
  ...
  return(
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css" integrity="sha512-MV7K8+y+gLIBoVD59lQIYicR65iaqukzvf/nwasF0nqhPay5w/9lJmVM2hMDcnK1OnMGCdVK+iQrJ7lzPJQd1w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
      ...
      <h2>➷ Sri Lanka's Best ⦁<br/><span>⟿ E - sinhala Platform ⟿</span></h2><br/>
      </div>
          ...
          <div className="Secarrousel">
            ...
            <div className="scontent" data-aos="slide-up">
                ...
                <div className="Sinfo-mainmy-box">
                  <div>
                  <div className="sinfo">
                      <p> “අයන්න කියන්න” නමින් සක්‍රිය වෙබ් අඩවියක් පවත්වාගෙන යාමට අප තුළ වූ අභිලාශය වසර ගණනක සිට දුටු සිහිනයකි. අති සාර්ථක අන්දමින් එය දොරට වඩින්නේ 2024 ජනවාරි 15 වන දාය. අතුඉති ඔස්සේ විසිර ගිය අසීමිත දැනුම් සම්භාරයක් මේ තුළ අන්තර්ගතය. එකම තැනකින් විශ්මිත වූ ඒ සියලු දැනුම ලබන්නට ඔබට ඇති එකම මාවත වන්නේ මෙම  වෙබ් අඩවියයි.
                      </p>
                  </div>
