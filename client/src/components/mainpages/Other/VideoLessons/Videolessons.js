                    ...
                    <div className='v-cards'>
                        <div className='v-text-card' id='v-text-card-lastitem'>
                            <div className='v-content '>
                                ...
                                <a className='v-link' href="https://drive.google.com/drive/folders/1dNExHTlRpsCiZc6Yh9Bcg50Tos_7Q2vk?usp=sharing">Explore</a>
                            </div>
                        </div>
                        ...
                        <div className='v-text-card' id='v-text-card-lastitem'>
                            <div className='v-content'>
                                ...
                                <h3>A/L</h3>
                                <h5>“අයන්න කියන්න” නමින් සිංහල සඟරාවක් පළ කිරීමේ අවශ්‍යතාව අප තුළ ඇතිව තිබූයේ මීට වසර ගණනාවකට ඔබ්බෙහි සිට ය.</h5>   
                                <a className='v-link' href="https://drive.google.com/drive/folders/1CcSm-gANgdgFHnuVGN9sc1QFJl4uSCW-?usp=sharing">Explore</a>
                                </div>
                        </div>
                        ...
                        <div className='v-text-card' id='v-text-card-lastitem'>
                            <div className='v-content'>
                                ...
                                <h3>Other Lessons</h3>
                                <h5>“අයන්න කියන්න” නමින් සිංහල සඟරාවක් පළ කිරීමේ අවශ්‍යතාව අප තුළ ඇතිව තිබූයේ මීට වසර ගණනාවකට ඔබ්බෙහි සිට ය.</h5>   
                                <a className='v-link' href="https://drive.google.com/drive/folders/13ryVdidaIaKF687XQoeRiFzgQzXk-VQq?usp=sharing">Explore</a>
                                </div>
                        </div>
