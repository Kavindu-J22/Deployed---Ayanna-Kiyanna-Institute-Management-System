      ...
      <section class="about" id="downfristabout">
          ...
          <div className="About-Card-container" data-aos="slide-up">
            ...
            <div className="About-card">
                ...
                <div className="About-card-content">
                      <h3>Teacher</h3>
                      <p>කැලණිය විශ්වවිද්‍යාලයේ සිංහල විශේෂවේදී ගෞරව උපාධිධාරියෙකි. කොළඹ විශ්වවිද්‍යාලයේ පශ්චාත් උපාධි අධ්‍යාපන ඩිප්ලෝමාධාරියෙකි. සාහිත්‍ය දේශන පවත්වන ජනප්‍රීය දේශකයෙකි. ලේඛකයෙකි.</p>
                </div>
            </div>
